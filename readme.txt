...
- When using VARCHAR() don't forget that in utf8 a char can be up to 4 bytes in size.
  A string with a max size of 100 chars can take up to 400 bytes in the mysql table.
